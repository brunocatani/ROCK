...
namespace rock
{
    ...
    public:
        ...
        struct DebugSnapshot
        {
            ...
            float physicsSubstepDeltaSeconds{ 0.0f };
    ...
    private:
        ...
        std::uint64_t _physicsSourceGameFrameIndex{ 0 };
        std::uint64_t _physicsSourceQueueSequence{ 0 };
        ...
        std::atomic<std::uint64_t> _snapshotSourceGameFrameIndexAtomic{ 0 };
        std::atomic<std::uint64_t> _snapshotSourceQueueSequenceAtomic{ 0 };
        std::atomic<float> _snapshotPhysicsRawDeltaSecondsAtomic{ 0.0f };
        std::atomic<float> _snapshotPhysicsSubstepDeltaSecondsAtomic{ 0.0f };
        std::atomic<float> _snapshotPhysicsRemainderDeltaSecondsAtomic{ 0.0f };
        std::atomic<float> _snapshotPhysicsAccumulatedDeltaSecondsAtomic{ 0.0f };
        std::atomic<float> _snapshotPhysicsSubstepProgressAtomic{ 0.0f };
        std::atomic<std::uint32_t> _snapshotPhysicsSubstepCountAtomic{ 0 };
        std::atomic<std::uint32_t> _snapshotPhysicsSubstepIndexAtomic{ 0 };
