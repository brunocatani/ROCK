...
namespace rock
{
    ...
    struct EquippedWeaponGripFrameInput
    {
        ...
        // A verified native reload can yield selected support-hand claims.
        // Provider animation authority composes with the live weapon grab.
    ...
    public:
        ...
        // retained contact presentation is active; input selection uses this
        ...
        // Applies the verified native-reload handoff before FRIK and again
        // from the coherent physics-frame snapshot. The logical support grip
        // remains intact.
    ...
    private:
        ...
        [[nodiscard]] bool isNativeReloadSupportHand(
            bool isLeft) const
        {
        ...
        // per-frame WeaponPartGrip state. The complete type is defined in
        // TwoHandedGripInternal.h, which every TU in weapon/two_handed includes,
        // so the unique_ptr destructor always sees it. Do not move that
        // definition into one .cpp: the destructor is emitted in the core TU.
