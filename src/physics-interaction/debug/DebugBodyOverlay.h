...
namespace rock::debug
{
    ...
    enum class MarkerOverlayRole : std::uint8_t
    {
        ...
        RightPalmAnchorBuildHand,
        LeftPalmAnchorBuildHand,
        RightPalmAnchorBuildFingerBase,
        LeftPalmAnchorBuildFingerBase,
        RightPalmAnchorBuildFingerCenter,
        LeftPalmAnchorBuildFingerCenter,
        RightPalmAnchorBuildFingerForward,
        LeftPalmAnchorBuildFingerForward,
        RightPalmAnchorBuildCrossPalmSeed,
        LeftPalmAnchorBuildCrossPalmSeed,
        RightPalmAnchorBuildProjectedCrossPalm,
        LeftPalmAnchorBuildProjectedCrossPalm,
        RightPalmAnchorBuildPalmDepth,
        LeftPalmAnchorBuildPalmDepth,
        RightPalmAnchorBuildTargetOrigin,
        LeftPalmAnchorBuildTargetOrigin,
        RightSoftContact,
        LeftSoftContact,
