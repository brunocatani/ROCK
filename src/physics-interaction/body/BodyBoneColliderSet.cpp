...
namespace rock
{
    ...
    {
        /*
         * A one-hand object grab owns the collision space around the driven hand.
         * The generated hand suite covers palm/fingers, while the body collider
         * table owns the three adjacent root-flattened arm bodies:
         * ForeArm1->ForeArm2, ForeArm2->ForeArm3, and ForeArm3->Hand. Returning
         * only this side-local chain keeps normal grabs from fighting their own
         * wrist/forearm without changing two-handed equipped-weapon suppression.
         */
