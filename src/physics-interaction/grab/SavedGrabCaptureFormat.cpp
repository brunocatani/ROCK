    ...
    namespace
    {
        ...
        json seatToJson(const SeatCapture& seat)
        {
            return json{
                ...
                { "solveReason", seat.solveReason },
                { "solveRotationDegrees", seat.solveRotationDegrees },
                { "solveTranslationGameUnits", seat.solveTranslationGameUnits },
                { "solveIterations", seat.solveIterations },
                { "solveObjectiveScore", seat.solveObjectiveScore },
                { "solveTermTouch", seat.solveTermTouch },
                { "solveTermPalmProx", seat.solveTermPalmProx },
                { "solveTermOverPen", seat.solveTermOverPen },
                { "solveTermWrap", seat.solveTermWrap },
                { "solveTermRodAxis", seat.solveTermRodAxis },
                { "solveTermGirth", seat.solveTermGirth },
        ...
        {
            return json{
                { "solverWeightTouch", tuning.solverWeightTouch },
                { "solverWeightPalmProx", tuning.solverWeightPalmProx },
                { "solverWeightOverPen", tuning.solverWeightOverPen },
                { "solverWeightWrap", tuning.solverWeightWrap },
                { "solverWeightRodAxis", tuning.solverWeightRodAxis },
                { "solverWeightGirth", tuning.solverWeightGirth },
                { "solverLambdaTranslate", tuning.solverLambdaTranslate },
                { "solverLambdaRotate", tuning.solverLambdaRotate },
                { "solverPalmSlackGameUnits", tuning.solverPalmSlackGameUnits },
                { "solverPenetrationLimitGameUnits", tuning.solverPenetrationLimitGameUnits },
                { "solverGirthWrappableRadiusGameUnits", tuning.solverGirthWrappableRadiusGameUnits },
