...
#define FRIK_CALL __cdecl
    ...
    struct FRIKApi
    {
         ...
         * Known levels: External=50, OffhandGrip=60, Attaboy=65, Pipboy=70, ConfigMode=70, PhysicsGrab=100.
         */
        bool (FRIK_CALL*setHandPoseWithPriority)(const char* tag, Hand hand, HandPoses handPose, int priority);

        // --- Skeleton & Movement (API v3) ---
        ...
        /**
         * Get the hand bone NiNode pointer.
         */
        RE::NiNode* (FRIK_CALL*getHandNode)(Hand hand);

        /**
         * Check if any game menu is open (pause, favorites, dialogue, pipboy, config, scope).
         */
        bool (FRIK_CALL*isAnyMenuOpen)();

        /**
         * Get the smoothed player position from the smooth movement system.
         */
