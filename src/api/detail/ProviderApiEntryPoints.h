...
{
    std::uint32_t ROCK_PROVIDER_CALL apiGetVersion();
    const char* ROCK_PROVIDER_CALL apiGetModVersion();
    bool ROCK_PROVIDER_CALL apiIsProviderReady();
    std::uint64_t ROCK_PROVIDER_CALL apiRegisterFrameCallback(
        RockProviderFrameCallback callback,
        void* userData);
    bool ROCK_PROVIDER_CALL apiUnregisterFrameCallback(
    ...
    RockProviderResultV1 ROCK_PROVIDER_CALL apiUnregisterFrameCallbackForOwnerV1(
        std::uint64_t ownerToken,
        std::uint64_t callbackToken);
    bool ROCK_PROVIDER_CALL apiGetFrameSnapshot(
        RockProviderFrameSnapshot* outSnapshot);
    RockProviderHand ROCK_PROVIDER_CALL apiGetPrimaryHandV1();
    RockProviderHand ROCK_PROVIDER_CALL apiGetOffhandHandV1();
    bool ROCK_PROVIDER_CALL apiGetHandFrameV1(
        RockProviderHand hand,
        RockProviderHandFrameV1* outFrame);
    bool ROCK_PROVIDER_CALL apiGetWeaponPartGripStateV1(
        RockProviderHand hand,
    ...
    RockProviderResultV1 ROCK_PROVIDER_CALL apiUnregisterConsumerV1(
        std::uint64_t ownerToken);
    std::uint32_t ROCK_PROVIDER_CALL apiGetGrantedCapabilitiesV1(
        std::uint64_t ownerToken);
    bool ROCK_PROVIDER_CALL apiGetProviderLimitsV1(
    ...
    RockProviderResultV1 ROCK_PROVIDER_CALL apiRequestTouchGrabYieldV1(
        std::uint64_t ownerToken,
        std::uint64_t scopeToken,
        std::uint64_t targetId,
        std::uint32_t targetGeneration);
    RockProviderResultV1 ROCK_PROVIDER_CALL
    apiSetEquippedWeaponHandlingAuthorityV1(
        std::uint64_t ownerToken,
        const RockProviderEquippedWeaponHandlingRequestV1* request);
    RockProviderResultV1 ROCK_PROVIDER_CALL
    apiClearEquippedWeaponHandlingAuthorityV1(std::uint64_t ownerToken);
    bool ROCK_PROVIDER_CALL apiGetEquippedWeaponHandlingStateV1(
        RockProviderEquippedWeaponHandlingStateV1* outState);
    RockProviderResultV1 ROCK_PROVIDER_CALL apiRequestEquippedWeaponHandV1(
        std::uint64_t ownerToken,
    ...
    RockProviderResultV1 ROCK_PROVIDER_CALL
    apiClearColliderVisualizationOverrideV1(std::uint64_t ownerToken);
    ...
    RockProviderResultV1 ROCK_PROVIDER_CALL apiSetWeaponPartTargetsV1(
        ...
        std::uint32_t targetCount);
    RockProviderResultV1 ROCK_PROVIDER_CALL apiClearWeaponPartTargetsV1(
        std::uint64_t ownerToken);
    RockProviderResultV1 ROCK_PROVIDER_CALL apiSetWeaponPartDriveTargetsV1(
        std::uint64_t ownerToken,
        const RockProviderWeaponPartDriveTargetV1* targets,
        std::uint32_t targetCount);
    RockProviderResultV1 ROCK_PROVIDER_CALL apiClearWeaponPartDriveTargetsV1(
        std::uint64_t ownerToken);
    ...
    bool ROCK_PROVIDER_CALL apiQueryEquippedWeaponClassificationV1(
    ...
    std::uint32_t ROCK_PROVIDER_CALL apiGetWeaponEvidenceDetailPointCountV1(
        std::uint32_t bodyId);
    ...
    bool ROCK_PROVIDER_CALL apiSetOffhandInteractionReservation(
        std::uint64_t ownerToken,
    ...
    bool ROCK_PROVIDER_CALL apiGetRawWandButtonStateV1(
        RockProviderHand hand,
