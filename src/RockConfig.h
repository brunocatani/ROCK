...
namespace rock
{
    ...
    public:
        ...
        bool rockShoulderStashAllowHmdFallback = true;
        ...
        RE::NiPoint3 rockShoulderStashFallbackRightOffsetGameUnits = RE::NiPoint3(17.5f, -5.0f, -6.85f);
        RE::NiPoint3 rockShoulderStashFallbackLeftOffsetGameUnits = RE::NiPoint3(-17.5f, -5.0f, -6.85f);
        float rockShoulderStashFallbackRadiusGameUnits = 11.0f;
