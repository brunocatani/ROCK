...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'palmTangentWorld\s*=\s*acquisitionPocket\.fingerForwardWorld[\s\S]*palmBitangentWorld\s*=\s*acquisitionPocket\.thumbSideWorld' 'Contact-patch probing must share the generated/proxy palm-pocket basis instead of rebuilding a mismatched tangent frame.'
