...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'generatedColliderFrameToGrabAuthorityFrame\(outProxyWorld\)' 'Proxy authority must adapt the generated collider palm convention locally instead of changing collider placement.'
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'generatedColliderFrameToGrabAuthorityFrame\(\*fallbackPalmAnchorWorld\)' 'Palm-anchor fallback must use the same grab-only generated-collider frame adapter.'
