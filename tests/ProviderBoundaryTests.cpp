...
int main()
{
    ...
    static_assert(ROCK_PROVIDER_FRAME_SNAPSHOT_V6_SIZE == 256);
    ...
    static_assert(offsetof(RockProviderFrameSnapshot, lifecycleFlags) > offsetof(RockProviderFrameSnapshot, physicsScaleRevision));
    static_assert(offsetof(RockProviderFrameSnapshot, worldGeneration) > offsetof(RockProviderFrameSnapshot, lastLifecycleReason));
    static_assert(offsetof(RockProviderFrameSnapshot, stableFrameCount) > offsetof(RockProviderFrameSnapshot, providerGeneration));
    static_assert(sizeof(RockProviderExternalBodyRegistration) == 32);
    static_assert(sizeof(RockProviderExternalContact) == 40);
    static_assert(ROCK_PROVIDER_API_VERSION >= 7);
    ...
    static_assert(offsetof(RockProviderApi, getBodyContactSnapshotV6) > offsetof(RockProviderApi, getDiagnosticInputSnapshotV5));
    static_assert(static_cast<std::uint32_t>(RockProviderBodyZoneKind::LeftShoulder) == 6);
    static_assert(static_cast<std::uint32_t>(RockProviderBodyZoneKind::RightShoulder) == 11);
    static_assert(static_cast<std::uint32_t>(RockProviderBodyContactTargetKind::Body) == 4);
    static_assert(static_cast<std::uint32_t>(RockProviderLifecycleFlag::PhysicsWriteAllowed) == (1u << 7));
    static_assert(static_cast<std::uint32_t>(RockProviderLifecycleReason::TransitionSettled) == 14);
