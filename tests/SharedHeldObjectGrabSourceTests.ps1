...
Require-Text 'src/physics-interaction/hand/Hand.h' 'enum class HeldObjectDriveMode[\s\S]*ProxyConstraint' 'Held objects must explicitly track native, shared, and proxy custom constraint drive modes.'
