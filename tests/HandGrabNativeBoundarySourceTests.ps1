...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'desiredObjectWorld\s*=\s*multiplyTransforms\(proxyAuthorityWorld,\s*_grabFrame\.proxyHandSpace\)' 'Held-object targets must use the corrected live palm/proxy frame for translation and rotation.'
