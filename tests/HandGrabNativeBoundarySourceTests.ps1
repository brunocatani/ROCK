...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'copySeatedSupportToGrabFrame[\s\S]*contactPatchSamples[\s\S]*contactPatchSampleCount[\s\S]*contactPatchUsedAsPivot' 'Seated palm-pocket promotion must update the active support sample model, not only the pivot point.'
