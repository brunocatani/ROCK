...
Require-Text 'src/physics-interaction/core/PhysicsInteraction.cpp' '_rightHand\.flushPendingCustomGrabAuthority\(world,\s*timing,\s*consumptionPlayerBasis\)' 'Right custom grab proxy authority must use the shared live consumption player-basis sample.'
Require-Text 'src/physics-interaction/core/PhysicsInteraction.cpp' '_leftHand\.flushPendingCustomGrabAuthority\(world,\s*timing,\s*consumptionPlayerBasis\)' 'Left custom grab proxy authority must use the shared live consumption player-basis sample.'
