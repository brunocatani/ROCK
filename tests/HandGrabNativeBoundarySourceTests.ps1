...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'grabbedFromPullCatch && !usingPinchPocket' 'Pulled hand-back adjustment must apply only outside final pinch authority.'
