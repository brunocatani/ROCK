...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'void Hand::flushPendingCustomGrabAuthority' 'Proxy constraint dynamic grab authority must flush after character movement and before solve.'
...
Require-Text 'src/physics-interaction/core/PhysicsInteraction.cpp' '_rightHand\.flushPendingCustomGrabAuthority\(world,\s*timing,\s*_grabFrameWallDeltaSecondsPrev,\s*_grabFrameWallDeltaSeconds\)' 'Right custom grab proxy authority must flush at the pre-solve boundary with the same-phase frame-duration feed-forward.'
Require-Text 'src/physics-interaction/core/PhysicsInteraction.cpp' '_leftHand\.flushPendingCustomGrabAuthority\(world,\s*timing,\s*_grabFrameWallDeltaSecondsPrev,\s*_grabFrameWallDeltaSeconds\)' 'Left custom grab proxy authority must flush at the pre-solve boundary with the same-phase frame-duration feed-forward.'
