...
Require-Text 'src/physics-interaction/core/PhysicsInteraction.cpp' '_rightHand\.flushPendingCustomGrabAuthority\(world,\s*timing,\s*_grabFrameEngineDeltaSecondsPrev,\s*_grabFrameEngineDeltaSeconds\)' 'Right custom grab proxy authority must flush at the pre-solve boundary with the engine frame-duration feed-forward.'
Require-Text 'src/physics-interaction/core/PhysicsInteraction.cpp' '_leftHand\.flushPendingCustomGrabAuthority\(world,\s*timing,\s*_grabFrameEngineDeltaSecondsPrev,\s*_grabFrameEngineDeltaSeconds\)' 'Left custom grab proxy authority must flush at the pre-solve boundary with the engine frame-duration feed-forward.'
