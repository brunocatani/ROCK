...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'tryGetGrabDriveObjectWorldTransform[\s\S]*HeldObjectDriveMode::ProxyConstraint[\s\S]*tryResolveLiveBodyWorldTransform' 'Proxy-constraint object-side authority must use the live hknp solver frame instead of the native mouse-spring BODY helper.'
