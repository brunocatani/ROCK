...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'clearGrabExternalHandWorldTransform\(_isLeft\)[\s\S]*_hasGrabVisualHandTransform\s*=\s*false[\s\S]*THREE-PHASE GRAB SEATED PIVOT REACQUIRE' 'Seated pivot reacquire must clear any previous visual hand relation before publishing again.'
