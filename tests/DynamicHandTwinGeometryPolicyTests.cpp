...
int main()
{
    ...
    canonicalHand.fingers[2][1].valid = true;
    canonicalHand.fingers[2][1].length = 3.5f;
    canonicalHand.fingers[2][1].radius = 0.6f;
    canonicalHand.fingers[2][1].convexRadius = 0.12f;
    ...
    liveHand.fingers[2][1].valid = true;
    liveHand.fingers[2][1].target.translate.z = 29.0f;
    liveHand.fingers[2][1].length = 8.0f;
    liveHand.fingers[2][1].radius = 1.0f;
    liveHand.fingers[2][1].convexRadius = 0.3f;
    ...
    assert(liveHand.fingers[2][1].valid);
    assert(liveHand.fingers[2][1].target.translate.z == 29.0f);
    assert(liveHand.fingers[2][1].length == 3.5f);
    assert(liveHand.fingers[2][1].radius == 0.6f);
    assert(liveHand.fingers[2][1].convexRadius == 0.12f);
    assert(!liveHand.fingers[4][0].valid);
