...
int main()
{
    ...
    contacts[1][2] = {
        ...
        .helpfulProbeTravelGameUnits = 0.2f,
        .active = true,
    };
    ...
    contacts[1][2].helpfulProbeTravelGameUnits = -0.2f;
    ...
    contacts[3][0] = {
        ...
        .helpfulProbeTravelGameUnits = 0.1f,
        .active = true,
    };
    const auto clamped = policy::solve(
        baseline,
        contacts,
        policy::Config{ .maximumClosureOpenUnits = 0.25f });
