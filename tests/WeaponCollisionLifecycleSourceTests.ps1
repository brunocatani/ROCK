...
Require-Text 'src/physics-interaction/weapon/WeaponCollision.cpp' 'tryResolveDescendantWorldTransform\(\s*packageDriveNode,\s*packageWorld,\s*instance\.sourceNode,\s*sourceWorld' 'Generated weapon bodies must follow descendant locals composed from the current weapon root.'
