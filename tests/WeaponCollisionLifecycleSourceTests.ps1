...
Require-Text 'src/physics-interaction/weapon/WeaponCollision.cpp' 'tryGetSupportGripEvidenceView[\s\S]{0,900}instance\.generatedSourceFrameCorrectionValid' 'Support-grip surface evidence must use the same corrected source frame as the physical bodies.'
