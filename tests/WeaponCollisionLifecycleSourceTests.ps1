...
Require-Text 'src/physics-interaction/weapon/WeaponOmodAuditPolicy.h' 'if \(input\.disabled\)[\s\S]{0,120}CoverageVerdict::Disabled[\s\S]{0,900}NodeNotFound,\s*\.selfHealCandidate\s*=\s*true' 'Disabled OMOD records must receive a diagnostic verdict without entering the missing-part self-heal path.'
