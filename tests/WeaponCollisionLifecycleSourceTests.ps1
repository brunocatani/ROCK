...
Require-Text 'src/physics-interaction/weapon/WeaponInstanceWitnessRuntime.cpp' 'AttachModToReferencePostCall' 'Weapon instance witness runtime must record attach-mod evidence only after the native mutation returns.'
...
Require-Text 'src/physics-interaction/weapon/WeaponInstanceWitnessRuntime.cpp' 'mod\.GetFormID\(\)' 'Attach-mod witness signals must carry the native mutated OMOD form instead of scanning the first equipped weapon stack.'
...
Require-Text 'src/physics-interaction/weapon/WeaponInstanceWitnessRuntime.cpp' 'WeaponInstanceWitnessSource::AttachMod' 'Only post-attach-mod witnesses may authorize native weapon visual remap.'
...
Require-Text 'src/physics-interaction/weapon/WeaponCollision.cpp' 'nativeVisualRemapAllowedForWitness' 'Weapon collision must block native remap requests that do not come from an attach-mod witness.'
