...
Require-Text 'src/physics-interaction/weapon/WeaponCollision.cpp' 'stable visual witness[\s\S]{0,1800}return;[\s\S]{0,600}findGeneratedWeaponShapeSources\(weaponNode,\s*generatedSources\)' 'Weapon visual stabilization must wait on the cheap visual witness before running the full generated source scan.'
