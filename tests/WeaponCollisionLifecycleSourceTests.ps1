...
Require-Text 'src/physics-interaction/weapon/WeaponCollision.cpp' 'canonicalConnectPointForAttachPoint[\s\S]{0,1800}recoveryNode[\s\S]{0,1800}tryAttach3DRecurse[\s\S]{0,800}DetachChild' 'Missing standard attachment slots must be synthesized only for a guarded retry and removed again when no model geometry is recovered.'
