...
Require-Text 'src/physics-interaction/weapon/WeaponCollision.h' 'getCurrentEquippedWeaponIdentityKey\(\)\s+const\s*\{\s*return\s+_cachedWeaponIdentityKey' 'Manual weapon ownership must be able to use the stable equipped-item identity separately from replaceable collision generations.'
