...
int main()
{
...

    {
        ...
        if (!palm.valid) {
            ...
            ok &= expectVectorNear(
                "palm grab -Y seat offset",
                rock::transform_math::localVectorToWorld(grabPalm, RE::NiPoint3{ 0.0f, -2.0f, 0.0f }),
                RE::NiPoint3{ -palm.yAxis.x * 2.0f, -palm.yAxis.y * 2.0f, -palm.yAxis.z * 2.0f });
        }
    }
