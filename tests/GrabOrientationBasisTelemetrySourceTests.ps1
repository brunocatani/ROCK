...
Require-Text 'src/physics-interaction/hand/HandFrame.h' 'computeGrabAuthorityFrameFromHandBasis[\s\S]*computeGrabPivotAPositionFromHandBasis\(handTransform,\s*isLeft\)' 'Source proof must derive dynamic grab authority from the root-flattened hand frame and handspace palm point.'
