...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'palmAnchorGrabAuthorityWorld\s*=[\s\S]*generatedColliderFrameToGrabAuthorityFrame\(out\.palmAnchorTargetWorld\)' 'Telemetry must include the grab-authority interpretation of the generated palm collider frame.'
