...
Require-Text 'src/physics-interaction/hand/HandGrab.cpp' 'handBoneGrabAuthorityWorld\s*=\s*computeGrabAuthorityFrameFromHandBasis\(out\.nativeFlattenedHandWorld,\s*_isLeft\)' 'Telemetry must include the hand-bone-derived grab-authority frame used by runtime grab math.'
