...
int main()
{
    ...
    }
    {
        ...
        support.weaponFormID = captured.weaponFormID;
        support.isLeft = true;
        support.grip = captured.support;
        ok &= expectBool("dynamic support cannot invent an authored equip pose", support.valid(), false);
        ...
        const auto authoredSupport = support;
        support.grip.authoredRole = rock::loose_weapon_authored_grab_policy::Role::Firing;
        ok &= expectBool("firing grip cannot enter a support-only transfer", support.valid(), false);
        support = authoredSupport;
        support.grip.fingerMask &= ~1u;
        ok &= expectBool("incomplete authored support rejects transfer", support.valid(), false);
        support = authoredSupport;
