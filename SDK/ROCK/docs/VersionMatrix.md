...
Public force grab is implemented as a queued v1 interaction command that executes through ROCK's existing dynamic grab path. Public force release and thrown drop are queued v1 interaction commands that execute through ROCK's existing release path.
