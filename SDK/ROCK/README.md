...
ROCK v1 exposes queued force grab, force release, and thrown drop through `requestForceGrabV1`, `requestForceReleaseV1`, `requestThrownDropV1`, and `getInteractionCommandResultV1`.
